...
-   Watchtower will post a notification every time it is started. This behavior [can be changed](arguments.md#without-sending-a-startup-message) with an argument.
...
services:
  watchtower:
    image: wiki-mod/watch-tower-ng:latest
